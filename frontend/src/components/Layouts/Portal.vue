...
onMounted(() => accessibilityStore.initAccessibilitySettings())
</script>
          ...
          <div class="flex items-center gap-2">
            ...
            <nav class="hidden md:flex space-x-1">
              ...
              <router-link to="/login" class="login-button">
                <svg xmlns="http://www.w3.org/2000/svg" class="login-icon" viewBox="0 0 24 24" fill="none"
            ...
            <button @click="mobileMenuOpen = !mobileMenuOpen" class="md:hidden hamburger-button"
              aria-label="เปิด/ปิดเมนู" :aria-expanded="mobileMenuOpen">
      ...
      <div v-if="mobileMenuOpen" class="mobile-menu md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
          <router-link to="/" class="mobile-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="mobile-icon" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2">
          ...
          <div class="footer-section">
            ...
            <div class="footer-contact">
              <div class="footer-contact-item">
                <svg xmlns="http://www.w3.org/2000/svg" class="footer-icon" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2">
            ...
            <ul class="footer-links">
              <li>
                <a href="https://www.moph.go.th" target="_blank" rel="noopener" class="footer-link">
                  <svg xmlns="http://www.w3.org/2000/svg" class="footer-link-icon" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2">
          ...
          <div class="footer-section">
            ...
            <div class="social-links">
              <a href="#" class="social-link" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" class="social-icon" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2">
